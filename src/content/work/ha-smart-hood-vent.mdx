...
Every sensitivity setting is a slider on the dashboard, so anyone using this can tune it without editing YAML — the difference between "works for me" and "works in someone else's kitchen." Toggle the hood by hand and the automation backs off for 30 minutes; the system helps, it doesn't fight the person holding the pan. And after two hours straight, the hood forces off and posts a notification, in case I left a pot on and walked out the door.
